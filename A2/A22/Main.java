 ...
 *
 *  *Version 1.2.6, 2/7/03, [C. Scott Ananian] Renamed 'assert' function
 * 'ASSERT' to accomodate Java 1.4's new keyword. Fixed a bug which certain
 * forms of comment in the JLex directives section (which are not allowed) to be
 ...
 *
 *  *Version 1.2.1, 9/15/97 [A. Appel] Fixed bugs 6 (character codes > 127) and
 * 10 (deprecated String constructor).
 *
 ...
 *
 *  *Version 1.1.4, 12/12/96, [Elliot Berk] Notes: Added %public directive to
 * make generated class public.
 *
 *  *Version 1.1.3, 12/11/96, [Elliot Berk] Notes: Converted assertion failure
 * on invalid character class when a dash '-' is not preceded with a
 * start-of-range character. Converted this into parse error E_DASH.
 *
 *  *Version 1.1.2, October 30, 1996 [Elliot Berk] Fixed BitSet bugs by
 * installing a BitSet class of my own, called JavaLexBitSet. Fixed support for
 * '\r', non-UNIX sequences. Added try/catch block around lexer generation in
 * main routine to moderate error information presented to user. Fixed macro
 ...
 *
 *  *Version 1.1.1, September 3, 1996 [Andrew Appel] Made the class "Main"
 * instead of "JavaLex", improved the installation instructions to reflect this.
 *
